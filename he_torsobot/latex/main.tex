...
The tested configurations showed that the maximum torque required of the arm's joints would take place in the shoulder pitch, shoulder roll, and elbow, and would be roughly of a magnitude of $4\,\si{N m}$. Considering this figure, and the estimated efficiency of a 3D printed cycloidal of 40\%-60\%, the primary gearhead ratio of 48:1 was chosen.

Following this, a prototype 24:1 gearhead was developed and tested, as detailed in \S~\ref{sec:prototype}, in order to inform the rest of the preliminary arm design.
...
\subsection{Prototype Testing}\label{sec:prototype}
